...
## Project Structure
    ...
    ├── testapiautosetting_124289  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124289`
...
2. Clone this repo and `cd testapiautosetting_124289`
